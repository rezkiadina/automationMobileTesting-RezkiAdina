...
public class ListPage extends BasePageObject {
  ...
  By elementListToPress = MobileBy.id("com.isl.simpleapp:id/text_view");
...
//        .perform();
  ...
  public void longPressList (){
    longPressList(findElementsList(elementListToPress).get(6));
  }

  public void multipleTaps(){
    multipleTapsList(findElementsList(elementListToPress).get(7));
  }
